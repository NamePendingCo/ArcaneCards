...
## 
## They should usually only exist to run once and then disappear. 
## Rarely should this ever be created directly. Instead we should 
## rely on EventLaunchers to create these based on their pre-defined 
## blueprint.
