...
## Helper function for constructors for target params.
func _set_target_base_vals(my_actor: Actor, my_card: Card, chosen: bool, 
targets_min: int=1, targets_max: int=1, persist=false):
	_set_base_vals(my_actor, my_card, chosen)
